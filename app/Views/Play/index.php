    ...
    <div class="content">
        ...
        <div class="main-content">
			...
			<ul class="nav nav-tabs">
			  <li class="active"><a href="#home" data-toggle="tab">Play</a></li>
			</ul>
			...
			<div class="row">
			  <div class="col-md-4">
				...
				<div id="myTabContent" class="tab-content">
				  ...
				  <form id="playtab" action="addplayer" method="POST">
					<div class="form-group">
						<label>Enter Amount </label>
						<input type="number" data-fv-identical="true" id="amount" name="amount" onkeypress='validate(event)' required="required" onchange='fieldChanged(event)' onpaste='validate(event)' oninput='validate(event)' class="form-control">
					</div>
					<div class="form-group">
						<label>Confirm Amount</label>
						<input type="number" data-fv-identical="true" id = "confirm" name= "confirm" onkeypress='validate(event)' required="required"  onchange='fieldChanged(event)' onkeypress='validate(event)' onpaste='validate(event)' oninput='validate(event)'  class="form-control">
					</div>
					<div class="btn-toolbar list-toolbar">
						<button class="btn btn-primary" onclick="return" type="submit"> Play </button>
					</div>
					</form>
				  </div>
				</div>
			...
			<footer>
				...
				<p class="pull-right">Economic Freedom made easy</p>
...
<script type="text/javascript">
	...
	function fieldChanged(evt){
	  ...
	  if( !regex.test(key) ) {
		...
		var pass = document.getElementById("amount").value;
		if(confirm != ""){
			if(confirm === pass){
